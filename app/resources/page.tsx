          ...
          <div className="relative overflow-hidden rounded-3xl border border-border bg-surface px-6 py-8 shadow-[0_28px_70px_-46px_hsl(var(--shadow)/0.72)] sm:px-10 sm:py-12">
            ...
            <div className="relative grid gap-8 lg:grid-cols-[minmax(0,1fr)_16rem] lg:items-end">
              ...
              <aside className="rounded-2xl border border-border bg-background/75 p-5 backdrop-blur sm:p-6">
                ...
                <p className="mt-5 text-4xl font-semibold tracking-tight">{resources.length}</p>
        ...
        <Container className="max-w-6xl">
          ...
          {resources.length ? (
              ...
              {resources.map((resource) => {
                ...
                return (
                  ...
                  >
                    ...
                    <h3 className="mt-7 text-2xl font-semibold tracking-tight transition-colors group-hover:text-primary">
                      {resource.title}
                    </h3>
                    <p className="mt-4 text-sm leading-7 text-muted-foreground">{resource.excerpt}</p>

                    {resource.audience ? (
                      <span className="mt-5 inline-flex w-fit items-center gap-2 rounded-full border border-border bg-background px-3 py-1.5 text-xs font-medium text-muted-foreground">
            ...
            <div className="mt-8 grid place-items-center rounded-2xl border border-dashed border-border bg-surface px-6 py-14 text-center">
              ...
              <h3 className="mt-5 text-2xl font-semibold tracking-tight">New resources are on the way.</h3>
